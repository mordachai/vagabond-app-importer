...
Click the **export icon** in the character sheet header to download a filled Vagabond hero record as a PDF. A **Save As** dialog will open so you can save it anywhere on your computer. You can choose between the dark and light sheet templates in Module Settings.
